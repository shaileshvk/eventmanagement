...
namespace Nop.Admin.Controllers
{
    ...
    {
        //custum staic variable
        static int parentprodctid = 0;
        ...
        // public ActionResult Create(ProductModel model, ProductModel.AddAssociatedProductModel model1, bool continueEditing)
        ...
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        // public ActionResult Create(ProductModel model, ProductModel.AddAssociatedProductModel model1, bool continueEditing)
        public ActionResult Create1(ProductModel model, bool continueEditing)
        {
        ...
        public ActionResult AssociatedProductAddPopup(int productId)
        {
            ...
            return View("AssociatedProductAddPopup", model);
        ...
        public ActionResult AssociatedProductAddPopup1(int productId)
        {
            parentprodctid = productId;
            //if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
            //    return AccessDeniedView();
      ...
      //     return View("Create", model);
        ...
        [HttpPost]
        [FormValueRequired("save")]
        public ActionResult AssociatedProductAddPopup1(string btnId, string formId, ProductModel.AddAssociatedProductModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedView();
